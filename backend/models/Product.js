...
const productSchema = new mongoose.Schema(
  {
    ...
    buyingPriceOriginal: { type: Number, min: 0, default: 0 },
    buyingCurrency: { type: String, trim: true, default: 'AED' },
    buyingPriceUSD: { type: Number, min: 0, default: 0 },
    buyingPriceRWF: { type: Number, min: 0, default: 0 },
    aedToUsdRate: { type: Number, min: 0, default: 0 },
    aedToRwfRate: { type: Number, min: 0, default: 0 },
    exchangeRateUpdatedAt: Date,
    exchangeRateSnapshot: {
      aedToUsd: { type: Number, default: 0 },
      aedToRwf: { type: Number, default: 0 },
