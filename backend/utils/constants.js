...
const LOAN_ITEM_STATUSES = ['UNPAID', 'PARTIALLY_PAID', 'PAID', 'RETURNED'];
const SALE_STATUSES = ['COMPLETED', 'CANCELLED'];
const PAYMENT_STATUSES = ['PAID', 'PARTIALLY_PAID', 'UNPAID'];
const SALE_SOURCES = ['RETAIL', 'ORDER', 'ON_DEMAND'];
...
module.exports = { PERMISSIONS, ROLES, ALL, PAYMENT_METHODS, PRODUCT_CONDITIONS, STOCK_TYPES, LOAN_STATUSES, LOAN_ITEM_STATUSES, SALE_STATUSES, PAYMENT_STATUSES, SALE_SOURCES, DEFAULT_PHONE_BRANDS, DEFAULT_CATEGORIES };