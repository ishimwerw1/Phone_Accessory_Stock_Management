          ...
          <Card className="shadow-sm border-0 h-100">
            ...
            <div className="p-3">
              ...
              <div className="small text-muted text-center mt-2">
                This month · Revenue {Number(data.monthRevenue || 0).toLocaleString()} RWF − COGS {Number(data.monthCost || 0).toLocaleString()} RWF = Gross {Number(data.grossProfit || 0).toLocaleString()} RWF · Expenses {Number(data.monthlyExpenses || 0).toLocaleString()} RWF
              </div>
